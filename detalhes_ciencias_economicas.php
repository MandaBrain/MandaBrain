	...
	?>
		<div class="container-fluid  espaco_cabecalho">
			<div class="form-group text-center">
					<h1>A bolsa de 60% no curso de <b>Economia</b> é perfeita para você!</h1>
			</div>
			<div class="row text-center">
				<h1><img class="img-responsive" src="img/faculdades/3515.jpg"</h1>
			</div>
			...
			<div class="row text-center letra_branca">
				<div class="col-xs-12 fundo_azul_detalhes_curso  bordas">
					<div class="form-group">
						...
						?>
						<div class="glyphicon glyphicon-home">  Rua Guaranésia, 425, São Paulo-SP</div>‎<br>
						<div class="glyphicon glyphicon-earphone">  (11) 2633-9000</div><br>
			...
			<div class="row text-center">
                    <div class="col-xs-12">
                        ...
                        <h1>Confira mais bolsas oferecidas pela Uninove</h1>
                        ...
                        <div class="col-xs-4">
                            <div class="panel panel-success ebooks_section_color">
                                <div class="panel-heading">
                                    <img src="img/faculdades/uninove.jpg" width="250" height="223">
                                </div>
                                <div class="panel-body">
                        ...
                        <div class="col-xs-4">
                            <div class="panel panel-success ebooks_section_color">
                                <div class="panel-heading">
                                    <img src="img/faculdades/ung.jpg" width="250" height="223">
                                </div>
                                <div class="panel-body">
